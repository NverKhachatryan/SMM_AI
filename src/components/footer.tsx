...
const Backlink = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="absolute left-5 bottom-5 flex place-items-center space-x-2 rounded border border-gray-300 bg-white px-3 py-1 text-sm font-semibold text-gray-900 shadow-sm dark:border-trueGray-700 dark:bg-trueGray-900 dark:text-trueGray-300"
    >
      <svg
        width="20"
        height="20"
